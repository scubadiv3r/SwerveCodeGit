...
public class Swervanator extends IterativeRobot {
    ...
    private static final Jaguar FRONT_LEFT_WHEEL = new Jaguar(5);
    private static final Jaguar FRONT_RIGHT_WHEEL = new Jaguar(6);
    private static final Jaguar BACK_LEFT_WHEEL = new Jaguar(7);
    private static final Jaguar BACK_RIGHT_WHEEL = new Jaguar(8);
